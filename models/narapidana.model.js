...
const Narapidana = db.define('Narapidana', {
  id_narapidana: {
    autoIncrement: true,
    allowNull: false,
    primaryKey: true,
...
Narapidana.belongsTo(User, { foreignKey: 'waliId', onDelete: 'CASCADE' });
Narapidana.belongsTo(TindakPidana, { foreignKey: 'tindakPidanaId', onDelete: 'CASCADE' });
...
(async () => {
  try {
    await db.sync();
    console.log("Narapidana table has been created.");
  } catch (error) {
